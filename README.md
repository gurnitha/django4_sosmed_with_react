...
#### 1.13. Menghubungkan basis data

        Menghubungkan basis data

        Menghubungkan database ke Django memerlukan beberapa konfigurasi. Kemudian, kita harus membuka file settings.py, mencari konfigurasi database, dan kemudian memodifikasinya.

        Di file settings.py, Anda akan menemukan baris serupa:
        ...
        Hebat – seperti yang Anda lihat, proyek ini masih berjalan di mesin SQLite3.

        Hapus konten ini dan ganti dengan ini:

        DATABASES = {
         'default': {
         'ENGINE': 'django.db.backends.postgresql_psycopg2',
         'NAME': django4_sosmed_with_react,
         'USER': 'supercore',
         'PASSWORD': 'supercorepassword',
         'HOST': 'localhost',
         'PORT': '5432',
         }
        }
        ...
        Kita baru saja memodifikasi mesin basis data tetapi juga mengisi informasi seperti nama basis data, pengguna, kata sandi, host, dan porta.

        Kunci ENGINE untuk database MySQL bervariasi. Selain itu ada beberapa key tambahan seperti USER, PASSWORD, HOST, dan PORT:

        • NAME: Kunci ini menyimpan nama database MySQL Anda
        • USER: Kunci ini menyimpan nama pengguna akun MySQL yang akan dihubungkan dengan database MySQL.
        • PASSWORD: Kunci ini menyimpan kata sandi untuk akun MySQL ini
        • HOST: Kunci ini menyimpan alamat IP tempat database MySQL Anda dihosting.
        • PORT: Kunci ini menyimpan nomor port tempat database MySQL Anda dihosting.

        Konfigurasi selesai. Mari jalankan migrasi dan lihat apakah semuanya bekerja dengan baik:
        ...
        Hebat! Kita baru saja mengonfigurasi Django dengan PostgreSQL.
